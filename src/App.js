...
export default class App extends Component {
  ...
  apiKey ='f37eb6d921ff4ca287b3e54573aa50b8';
    ...
    return (
      <div >
        ...
        <Routes>
          ...
          <Route  exact path="/technology" element = {<News setProgress={this.setProgress} apiKey={this.apiKey} key="tecchnology" pageSize={this.pageSize} country='us' category='technology' />}></Route>
        </Routes>
